        ...
        $(window)
            .resize(function () {
                ...
                if ($("nav").hasClass("mobile-nav")) {
                    ...
                    if ($(window).width() >= 1260 && $(window).top) {
        ...
        if (hasCounters) {
            var waypoint = new Waypoint({
                ...
                handler: function () {
                    ...
                    // Counter 1
                    var counter1 = new CountUp("count-1", 0, 4, 0, 3, options);
                    counter1.start();
                    // Counter 2
        ...
        if (hasCounters) {
            ...
            var waypoint = new Waypoint({
			  ...
			  handler: function() {
                    ...
                    counter2.start();
                    // Counter 3
                    var counter3 = new CountUp('count-3', 0, 500, 0, 3, options);
                    counter3.start();
                    // Counter 4
                    var counter4 = new CountUp('count-4', 0, 700, 0, 3, options);
>>>>>>> acd00250f98135679d4a1fc5125696176e692a52
                    counter4.start();
                    // init only once
                    this.destroy();
...
<<<<<<< HEAD
            ...
            customPaging: function (slider, i) {
                return (
                    '<a href="#">' +
                    $(
                        ".prod_single_thumbs_slider li:nth-child(" +
                            (i + 1) +
                            ")"
                    ).html() +
                    "</a>"
        ...
        $(".popup-gallery").magnificPopup({
            ...
            image: {
                ...
                titleSrc: function (item) {
                    return (
                        item.el.attr("title") +
                        "<small>DANCING BEAR PRODUCTIONS</small>"
                    );
                },
            },
        });
...
-------------------------------------------------- */
    ...
    /* --------------------------------------------------
	Zusatz-Layout GG Magnific Popup
-------------------------------------------------- */
    ...
    $(document).ready(function() {
        $('.popup-gallery').magnificPopup({
            ...
            image: {
                ...
                titleSrc: function(item) {
                    return item.el.attr('title') + '<small>DANCING BEAR PRODUCTIONS</small>';
                }
            }
        });
    });
...
<<<<<<< HEAD
            ...
            $(".kenburns").kenburns({
                images: [
                    "../images/2440x1578.png",
                    "../images/2440x1578.png/999/eee",
                    "../images/2440x1578.png/ccc/111",
=======
            $('.kenburns').attr('width', w_width);
            $('.kenburns').attr('height', w_height);
            $('.kenburns').kenburns({
                images: ['../images/2440x1578.png',
                    '../images/2440x1578.png/999/eee',
                    '../images/2440x1578.png/ccc/111'
>>>>>>> acd00250f98135679d4a1fc5125696176e692a52
                ],
